<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ \Route::is('book-category.*') ? 'active' : '' }}">
            <a href="{{ route('book-category.index') }}" class="menu-link">
        ...
        <li class="menu-item">
            <form id="logout-form" action="{{ route('logout') }}" method="POST">
                @csrf
                <button type="button" class="menu-link text-danger" id="logout-button">
